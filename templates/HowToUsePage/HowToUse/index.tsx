        ...
        <Section>
            <div className="container md:py-10 lg:pt-16 xl:pt-20">
                <Heading
                    ...
                    textLarge="Get started with Emailoverflow - AI chat app today and experience the power of AI in your conversations!"
                />
                    ...
                    <div className="flex-1">
                        ...
                        <div className="relative mb-16">
                            ...
                            <div className="body-2 text-n-2">
                                <p className="mb-6">
                                    {`To create an account with Emailoverflow - AI
                                        ...
                                        various features. Emailoverflow's AI chat
                                ...
                                <p className="mb-6">
                                    ...
                                    world, Emailoverflow is the perfect choice.
                                </p>
                            </div>
                            <div
