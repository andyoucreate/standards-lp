          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="body-1 text-n-2">
                By accessing and using Standards, you accept and agree to be bound by the terms and
            ...
            <div>
              ...
              <p className="body-1 text-n-2 mb-4">
                Permission is granted to temporarily access the materials on Standards for personal,
            ...
            <div>
              ...
              <p className="body-1 text-n-2">
                ...
                interruption) arising out of the use or inability to use the materials on Standards,
                even if Standards or a Standards authorized representative has been notified orally
            ...
            <div>
              ...
              <p className="body-1 text-n-2">
                ...
                not imply endorsement by Standards of the site. Use of any such linked website is at
                the user's own risk.
              </p>
            </div>
